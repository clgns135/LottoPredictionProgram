...
# 그래디언트 부스팅 회귀 모델 학습
model = GradientBoostingRegressor(n_estimators=1000, random_state=42)  # n_estimators 조정
...
print(f"\n학습 데이터 정확도: {train_accuracy:.2f}%") # 81.58%
print(f"테스트 데이터 정확도: {test_accuracy:.2f}%") # -39.66%
