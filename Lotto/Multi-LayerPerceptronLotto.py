...
# 다층 퍼셉트론 회귀 모델 학습
model = MLPRegressor(hidden_layer_sizes=(500, 500), activation='relu', random_state=42)  # 은닉층 크기와 활성화 함수 조정
...
print(f"\n학습 데이터 정확도: {train_accuracy:.2f}%") # 4.93%
print(f"테스트 데이터 정확도: {test_accuracy:.2f}%") # -12.80%
